...
//   const [password, setPassword] = useState("");
//   const [user, setUser] = useState(null);
//   const [showUserlogin, setShowUserlogin] = useState(false); // modal visible by default
...
//   if (!showUserlogin) return null; // hide modal when false
